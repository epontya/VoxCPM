...
> **Personal fork note:** I'm using this project to experiment with Voice Design and multilingual synthesis for a side project. Main areas of interest: Spanish/French cloning quality and the diffusion sampling speed. Will add notes under [Personal Notes](#personal-notes) as I go.
...
- Tested Voice Design with Spanish prompts — results are impressive, especially for neutral/professional tones.
- For faster local inference, I found reducing the diffusion steps from the default to ~20 gives acceptable quality with noticeably shorter generation time.
- TODO: benchmark cloning quality on French vs. Spanish reference clips.
